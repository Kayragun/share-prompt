...
export function ThemeToggle() {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="relative flex items-center justify-center w-8 h-8 rounded-full outline-none ring-2 ring-transparent hover:ring-primary transition-all bg-background/50 backdrop-blur-sm border border-border/50">
